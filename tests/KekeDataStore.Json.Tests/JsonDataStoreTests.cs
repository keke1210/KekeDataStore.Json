...
namespace KekeDataStore.Json.Tests
{
    [TestFixture]
    public class JsonDataStoreTests
    {
        private readonly IDataStore<Contact> _dataStore;

        public JsonDataStoreTests()
        {
            // FilePath will be the default at the temporary directory
            _dataStore = new JsonDataStore<Contact>("NewOne");
        }
